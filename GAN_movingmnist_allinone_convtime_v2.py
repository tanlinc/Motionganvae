...
code_time = tf.stack([code_time_3, code_time_4, code_time_5])  # (5, 50, 256, 4, 4)
...
fixed_code_time = tf.stack([fixed_code_time_3, fixed_code_time_4, fixed_code_time_5])  # (5, 50, 256, 4, 4)
