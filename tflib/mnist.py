...
def mnist_generator(data, batch_size, n_labelled, limit=None, shuffle=True):
    images, targets = data
    ...
    def get_epoch():
        ...
        if(n_labelled is not None and shuffle):
            numpy.random.set_state(rng_state)
...
def load(batch_size, test_batch_size, n_labelled=None):
    ...
    return (
        ...
        mnist_generator(test_data, test_batch_size, n_labelled, shuffle=False)
    )
